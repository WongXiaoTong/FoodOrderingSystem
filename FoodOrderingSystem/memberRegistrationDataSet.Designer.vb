...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("memberRegistrationDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class memberRegistrationDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As memberRegistrationDataSet = CType(MyBase.Clone,memberRegistrationDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "memberRegistrationDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/memberRegistrationDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As memberRegistrationDataSet = New memberRegistrationDataSet()
    ...
    Partial Public Class TableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddTableRow(ByVal Username As String, ByVal Address As String, ByVal City As String, ByVal Gender As String, ByVal Phone_No As Integer, ByVal Email As String) As TableRow
            Dim rowTableRow As TableRow = CType(Me.NewRow,TableRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Username, Address, City, Gender, Phone_No, Email}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Function FindById(ByVal Id As Decimal) As TableRow
    ...
    Partial Public Class TableRow
        ...
        Public Property Id() As Decimal
            Get
                Return CType(Me(Me.tableTable.IdColumn),Decimal)
            End Get
            Set
...
Namespace memberRegistrationDataSetTableAdapters
    ...
    Partial Public Class TableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Username = 1"& _ 
                " AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Add"& _ 
                "ress = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNul"& _ 
                "l_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_Gende"& _ 
                "r = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Phon"& _ 
                "e_No = 1 AND [Phone No] IS NULL) OR ([Phone No] = @Original_Phone_No)) AND ((@Is"& _ 
                "Null_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Id", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 5, 0, "Id", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Username], [Address], [City], [Gender], [Phone No], ["& _ 
                "Email]) VALUES (@Username, @Address, @City, @Gender, @Phone_No, @Email);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT"& _ 
                " Id, Username, Address, City, Gender, [Phone No], Email FROM [Table] WHERE (Id ="& _ 
                " SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Username] = @Username, [Address] = @Address, [City] = @"& _ 
                "City, [Gender] = @Gender, [Phone No] = @Phone_No, [Email] = @Email WHERE (([Id] "& _ 
                "= @Original_Id) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username"& _ 
                "] = @Original_Username)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([A"& _ 
                "ddress] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([Ci"& _ 
                "ty] = @Original_City)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gende"& _ 
                "r] = @Original_Gender)) AND ((@IsNull_Phone_No = 1 AND [Phone No] IS NULL) OR (["& _ 
                "Phone No] = @Original_Phone_No)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR"& _ 
                " ([Email] = @Original_Email)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Username, Address, City, Gender, [Ph"& _ 
                "one No], Email FROM [Table] WHERE (Id = @Id)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_Id", Global.System.Data.SqlDbType.[Decimal], 0, Global.System.Data.ParameterDirection.Input, 5, 0, "Id", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Id", Global.System.Data.SqlDbType.[Decimal], 5, Global.System.Data.ParameterDirection.Input, 5, 0, "Id", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.FoodOrderingSystem.My.MySettings.Default.memberRegistrationConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Username, Address, City, Gender, [Phone No], Email FROM dbo.[Table]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As memberRegistrationDataSet.TableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As memberRegistrationDataSet.TableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As memberRegistrationDataSet.TableDataTable = New memberRegistrationDataSet.TableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As memberRegistrationDataSet.TableDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As memberRegistrationDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Decimal, ByVal Original_Username As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_Gender As String, ByVal Original_Phone_No As Global.System.Nullable(Of Integer), ByVal Original_Email As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Username As String, ByVal Address As String, ByVal City As String, ByVal Gender As String, ByVal Phone_No As Global.System.Nullable(Of Integer), ByVal Email As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal Address As String, ByVal City As String, ByVal Gender As String, ByVal Phone_No As Global.System.Nullable(Of Integer), ByVal Email As String, ByVal Original_Id As Decimal, ByVal Original_Username As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_Gender As String, ByVal Original_Phone_No As Global.System.Nullable(Of Integer), ByVal Original_Email As String, ByVal Id As Decimal) As Integer
            If (Username Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal Address As String, ByVal City As String, ByVal Gender As String, ByVal Phone_No As Global.System.Nullable(Of Integer), ByVal Email As String, ByVal Original_Id As Decimal, ByVal Original_Username As String, ByVal Original_Address As String, ByVal Original_City As String, ByVal Original_Gender As String, ByVal Original_Phone_No As Global.System.Nullable(Of Integer), ByVal Original_Email As String) As Integer
            Return Me.Update(Username, Address, City, Gender, Phone_No, Email, Original_Id, Original_Username, Original_Address, Original_City, Original_Gender, Original_Phone_No, Original_Email, Original_Id)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As memberRegistrationDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As memberRegistrationDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._tableTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As memberRegistrationDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._tableTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As memberRegistrationDataSet) As Integer
